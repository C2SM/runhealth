"""Sphinx configuration for the runhealth documentation."""
...
html_theme = "furo"
html_title = f"runhealth {release}"
html_static_path = ["_static"]
html_css_files = ["custom.css"]
html_theme_options = {
    "source_repository": "https://github.com/C2SM/runhealth/",
    "source_branch": "main",
    "source_directory": "docs/",
    "footer_icons": [
        {
            "name": "GitHub",
            "url": "https://github.com/C2SM/runhealth",
            "html": '<svg stroke="currentColor" fill="currentColor" viewBox="0 0 16 16">'
            ...
            '0 .21.15.46.55.38A7.995 7.995 0 0 0 16 8c0-4.42-3.58-8-8-8z"></path></svg>',
            "class": "",
        },
    ],
}
